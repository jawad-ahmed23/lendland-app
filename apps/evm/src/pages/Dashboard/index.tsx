...
import { poolTags } from '../../../data/dashboardData'
...
const Dashboard: React.FC = () => {
  ...
  const [currentPool, setCurrentPool] = useState<any>("All")

  const handleSearchInputChange: InputHTMLAttributes<HTMLInputElement>["onChange"] =
    (changeEvent) => setSearchValue(changeEvent.currentTarget.value);
        ...
        <div className="mb-6 lg:flex lg:items-center lg:justify-between">
          ...
          {/* {pools.length > 0 && ( */}
            <TagGroup
              ...
              tags={poolTags}
              // activeTagIndex={currentPool}
              activeTag={currentPool}
              onTagClick={setCurrentPool}
            />
          {/* )} */}
        </div>
